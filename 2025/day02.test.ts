...
import { part1 as p1, part2 as p2} from './day02.ts'
...
t("sample", () => e(p1(sample)).toBe(1227775554));
const t1a = parseInt(readFileSync("day02.p1.answer.txt").toString());
t("p1", () => e(p1(t1)).toBe(t1a));
});

d("part2",()=>{
t("tripleRepeat", ()=>e(p2("121211-121213")).toBe(121212));
t("1", ()=>e(p2("11-22")).toBe(33));
t("2", ()=>e(p2("95-115")).toBe(210));
t("3", ()=>e(p2("998-1012")).toBe(2009));
t("4", ()=>e(p2("121211-121213")).toBe(121212));
t("first below start", () => e(p2("495900-505500")).toBe(5009550));
t("sample", () => e(p2(sample)).toBe(4174379265));
const t2a = parseInt(readFileSync("day02.p2.answer.txt").toString());

t("p2", () => e(p2(t1)).toBe(t2a));
});